  ...
  return (
    <section id="blog" className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center text-gray-800 mb-8">Latest Insights from Our Blog</h2>
        <p className="text-lg text-center text-gray-600 mb-12">
          Explore our latest articles to stay updated on trends, tips, and strategies for your business.
        </p>
        <div className="flex flex-wrap justify-center gap-6 md:gap-8">
          {/* Blog Post 1 */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 w-full sm:w-80">
            <Image
            ...
            <div className="p-4">
              ...
              <Link href="#">
                <button className="px-4 py-2 bg-blue-800 text-white rounded-full transition duration-300 hover:bg-blue-700">
                  Read More
                </button>
              </Link>
            </div>
